...
pub async fn handle_register(
    ...
    if user_not_found {
        if params.password != params.confirmation {
            ...
            s = format!("Congratulations. You have been successfully registered with EzyTutor and your tutor_name/user_name is: {} and tutor id is: {}. To start using EzyTutor, please login with your credentials.",tutor_response.tutor_name, tutor_response.tutor_id);
            // Hash the password
